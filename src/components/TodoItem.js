...
export default function TodoItem({ todo, onDelete, onItemToggle }) {
    return (
        <ul>
            <li className={`list-disc text-xl font-medium text-gray-900 mb-3 flex items-center justify-between p-3 rounded-lg border-2 border-black ${todo.is_completed ? 'bg-gray-300' : ''}`}>
